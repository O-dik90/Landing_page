            ...
            <Grid container>
              ...
              >
                ...
                <MKTypography variant="body2" color="text" mb={2}>
                  Whether you’re a client looking for a production partner, a budding storyteller,
                  or someone simply moved by our mission, we want to hear from you!
                </MKTypography>
                ...
                <Grid container spacing={1}>
                  ...
                  <Grid item xs={9}>
                    <MKTypography variant="body2" color="text">
                      Rt 001/Rw 010 Brangkali, Sukorini, Manisrenggo, Klaten, Jawa Tengah
                    </MKTypography>
                  </Grid>
                </Grid>
                <Grid container spacing={1}>
